...
// Initialize variables to hold patient data if editing
$patientId = "Auto";
$fullName = "";
$email = "";
$address = "";
...
<div class="page">
    <div class="left">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a class="active" href="#"><?php echo isset($_GET['id']) ? 'Edit Patient' : 'Add New Patient'; ?></a>
            </li>
        </ul>
    </div>
</div>
...
<div class="container2">
    <form id="patientForm" action="insert_patient.php" method="POST" enctype="multipart/form-data">
        <div class="form-group">
            <label for="patientId">Patient ID:</label>
            <input type="text" id="patientId" name="patientId" class="form-control" value="<?php echo $patientId; ?>" readonly>
        </div>
        <div class="form-group">
