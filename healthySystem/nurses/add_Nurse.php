...
// Initialize variables to hold nurse data if editing
$nurseId = "Auto";
$fullName = "";
$email = "";
$address = "";
...
if(isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM users WHERE id = $nurseId";
...
<div class="page">
    <div class="left">
        <h1><?php echo isset($_GET['id']) ? 'Edit Nurse' : 'Add New Nurse'; ?></h1>
        <ul class="breadcrumb">
            <li>
            ...
            <li>
                <a class="active" href="#"><?php echo isset($_GET['id']) ? 'Edit Nurse' : 'Add New Nurse'; ?></a>
            </li>
        </ul>
    </div>
</div>
...
<div class="container2">
    <form id="nurseForm" action="insert_nurse.php" method="POST" enctype="multipart/form-data">
        <div class="form-group">
            <label for="nurseId">Nurse ID:</label>
            <input type="text" id="nurseId" name="nurseId" class="form-control" value="<?php echo $nurseId; ?>" readonly>
        </div>
        <div class="form-group">
