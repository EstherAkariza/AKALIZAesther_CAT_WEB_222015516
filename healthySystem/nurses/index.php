...
<div class="page">
    ...
    <a href="./?page=add_Nurse" class="btn-download">
        <i class='bx bxs-cloud-download'></i>
        <span class="text">Add New Nurse</span>
    </a>
</div>
...
<div id="nurseTable" style="display: none;">
    ...
    <div class="DataTable">
        ...
        <table>
            ...
            <tbody>
                <?php
                // Fetch data from the users table where role is nurse
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><div class='image-container'><img src='".validate_image($row["image"])."' alt='Nurse Image'></div></td>";
                        
                        // Display status with appropriate styling
                        if ($row["status"] == "non_active") {
                            echo "<td class='not-available'>Blocked</td>";
                            echo "<td><a href='delete.php?page=nurses&table=users&status=block&id=".$row["id"]."' onclick='return confirm(\"You are going to block this user?\")'>Block</a> | <a href='./?page=add_Nurse&id=".$row["id"]."'>Update</a> | <a href='delete.php?table=users&page=nurses&users&id=".$row["id"]."' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a></td>"; // Action buttons
                        } else {
...
<script>
    ...
    setTimeout(function() {
        ...
        var tableDiv = document.getElementById('nurseTable');
